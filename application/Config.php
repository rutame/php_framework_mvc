 ...
 */
    ...
    //Constantes
    define('BASE_URL', 'http://localhost/aprendomvc/');
    define('DEFAULT_CONTROLLER', 'index'); 
    define('DEFAULT_LAYOUT', 'default');
   
    define('APP_NAME', 'Mi FrameWork');   
    define('APP_SLOGAN', 'Mi Primer FrameWork PHP MVC!'); 
    define('APP_COMPANY', 'pedrog.grafycomp.com'); 
    define('SESSION_TIME', 10);
    
    //!Atención: Clave irreversible! Generada con uniqid()
    define('HASH_KEY', '53caf6e5e9d44');
